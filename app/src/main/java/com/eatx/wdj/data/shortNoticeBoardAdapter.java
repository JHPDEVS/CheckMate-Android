...
public class shortNoticeBoardAdapter extends RecyclerView.Adapter<shortNoticeBoardAdapter.MyViewHolder> {
    ...
    public shortNoticeBoardAdapter (Context context,List<noticeBoardModel> posts){
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder (View view){
            ...
            mContainer = view.findViewById(R.id.noticeboard_container);
        }
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.row_notice_item,parent,false);
